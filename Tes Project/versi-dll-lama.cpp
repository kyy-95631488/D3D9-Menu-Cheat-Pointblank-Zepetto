...
//    int menuColorIndex = 3; // Default: Blue
//    int borderColorIndex = 3; // Default: Blue
//    int crosshairColorIndex = 1; // Default: Red
//    int crosshairType = 0;
//    int crosshairSize = 5;
//    // Key state tracking for debouncing
//    ULONGLONG lastKeyTime = 0;
//    const ULONGLONG keyDelay = 150; // Milliseconds delay for key repeat
//
...
//    }
//
//    void DrawText(LPDIRECT3DDEVICE9 device, const char* text, int x, int y, DWORD color, bool shadow = false) {
...
//            }
//            pFont->DrawTextA(pSprite, text, -1, &rect, DT_LEFT | DT_NOCLIP, color);
//        }
//    }
//
...
//        };
//        for (auto& r : borders)
//            device->Clear(1, &r, D3DCLEAR_TARGET, border, 0, 0);
//
//        D3DRECT shadow[] = {
...
//        DWORD crosshairColor = predefinedColors[crosshairColorIndex].value;
//
//        if (pLine) {
//            pLine->Begin();
//            if (crosshairType == 1) { // Dot
...
//            }
//            else if (crosshairType == 3) { // Circle
...
//
//        borderColor = predefinedColors[borderColorIndex].value;
...
//        if (pSprite) pSprite->End();
//
//        // Navigation and value adjustment with debouncing
//        if (currentTime - lastKeyTime >= keyDelay) {
...
//D3DMenu g_Menu;
//int espNameTag = 0;
//int antiKick = 0; // New variable for anti-kick
//int menuColorIndex = 3; // Blue
//int borderColorIndex = 3; // Blue
//int crosshairType = 0;
//int crosshairColorIndex = 1; // Red
//int crosshairSize = 5;
//
//// Memory patching for ESP Name Tag
...
//        if (hModule) {
//            targetAddress = (LPVOID)((DWORD)hModule + 0x62B0EB);
...
//        BYTE patchOn[] = { 0xC6, 0x01, 0x01, 0x8D, 0x49, 0x08 };
...
//        // Enable anti-kick: Replace "js" (0x78) with "jmp" (0xEB)
...
//    }
//    else if (!enable && isPatched) {
//        // Restore original instruction: "js" (0x78, 0x15)
...
//    if (!init) {
//        // Initialize menu with ESP Name Tag, Anti-Kick, and existing customization options
//        g_Menu.CreateItem("ESP Name Tag", &espNameTag, 1, 0, D3DCOLOR_ARGB(255, 255, 100, 100));
//        g_Menu.CreateItem("Anti-Kick", &antiKick, 1, 0, D3DCOLOR_ARGB(255, 255, 100, 100)); // New menu item
...
//    g_Menu.crosshairSize = crosshairSize;
//
//    // Apply patches based on menu state
//    ToggleESPNameTag(espNameTag != 0);
//    ToggleAntiKick(antiKick != 0); // Apply anti-kick patch
//
//    g_Menu.Render(pDevice, "Kenny Chan");
